        ...
        <CardContent>
          <form action={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                defaultValue={jobData?.job.title ?? ""}
                type="text"
                id="jobTitle"
                name="jobTitle"
                required
            ...
            <div>
              ...
              <textarea
                defaultValue={jobData?.job.description ?? ""}
                id="jobDescription"
                name="jobDescription"
                required
                rows={5}
            ...
            <div>
              ...
              <input
                defaultValue={jobData?.job.address ?? ""}
                type="text"
                id="jobAddress"
                required
                name="jobAddress"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  name="jobType"
                  required
                  defaultValue={jobData?.job.type ?? "FULL_TIME"}
              ...
              <div>
                ...
                <select
                  ...
                  name="shiftType"
                  required
                  defaultValue={jobData?.job.shiftType}
                  className="mt-1 block w-full rounded-md border border-background-800 bg-background-950 px-3 py-2 text-text-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950"
                >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  min={1}
                  max={24}
                  defaultValue={Number(jobData?.job.shiftLengthHours) ?? 8}
                  className="mt-1 block w-full rounded-md border border-background-800 bg-background-950 px-3 py-2 text-text-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950"
                />
